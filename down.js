...
var img_url = "https://dab1nmslvvntp.cloudfront.net/wp-content/uploads/2015/07/1436439824nodejs-logo.png";
...
function download_image_from_url(img_url) {
	...
	if (url_info.protocol == 'http:') {
		...
		http.get(img_req_options, (res) => {
			...
			if (res.statusCode != 200) {
				...
				var fsWriter = fs.createWriteStream("photos/" + img_name);
				...
				fsWriter.on('finish', () => {
					console.log('Success download imave ');
				});
			}
		});
...
download_image_from_url(img_url);
